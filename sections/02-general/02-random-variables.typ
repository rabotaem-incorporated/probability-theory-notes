...
#proof[
    ...
    5. Проверим по Гейне второе, пусть $x_n arrow.tr +oo$:
        $
            F_xi (x_n) = P_xi (-oo, x_n] -->_"непр. снизу" P_xi (Union_(n = 1)^oo (-oo, x_n]) = P(-oo, +oo) = 1.
        $
...
#def[
    _Случайная величина $xi$ непрерывная_ (или _распределение случайной величины $xi$ непрерывно_), если $P(xi = x) = 0$ для любого $x$.
]
