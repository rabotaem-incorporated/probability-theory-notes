...
#notice[
    ...
    2. $cov(xi, nu) =: dotp(xi, eta)$ --- тоже скалярное произведение. Единственное, надо отождествить случайные величины отличающиеся на константу почти наверное (так как для таких случайных величин не следует, что они равны). Тогда $sqrt(D xi)$ --- норма.
