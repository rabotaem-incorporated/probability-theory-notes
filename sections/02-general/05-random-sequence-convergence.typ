...
#example(name: "метод Монте-Карло")[
    Пусть $Phi$ --- тело в $RR^d$. Хотим найти его $n$-мерный объем, причем для каждой точки не сложно проверить $x in Phi$ или $x in.not Phi$.
