...
#th[
  Рассмотрим произвольное симметричное случайное блуждание по $ZZ$  (не обязательно в соседние точки). $xi_1$, $xi_2$, ... --- независимые симметричные случайные величины. $S_n = xi_1 + xi_2 + ... + xi_n$.
